...
INSERT INTO patient (address, email, name, password, phone, gender) VALUES
...
use cms <!-- changes current database -->

<!-- db.prescriptions references the prescription collection within the current database, here cms -->
